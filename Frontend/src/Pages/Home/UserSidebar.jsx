    ...
    <div className="max-w-[20em] w-full h-screen flex flex-col border-r border-r-white/10">
      ...
      <div className="flex items-center justify-between p-3">
        <div className="flex items-center gap-3 cursor-pointer">
          <Link
            to="/profile"
            className="flex items-center gap-3 hover:bg-gray-800 p-2 rounded-lg transition-all"
          >
        ...
        <button onClick={handleLogout} className="btn btn-primary btn-sm px-5">Logout</button>
      </div>
